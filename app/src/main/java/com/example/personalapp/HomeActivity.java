...
public class HomeActivity extends AppCompatActivity {
    ...
    private CardView budgetCardView, todayCardView, weekCardView, monthCardView, homeBtn, historyCardView;
    ...
    private void getBudgetAmount() {
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                personalRef.child("budget").setValue(totalAmountBudgetB);
            }
    ...
    private void getWeekSpentAmount() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("expenses").child(onlineUserID);
        Query query = reference.orderByChild("weeks").equalTo(weeks.getWeeks());
