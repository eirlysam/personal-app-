...
public class WeeklyAnalyticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalAmountSpendOn = (TextView) findViewById(R.id.totalAmountSpentOn);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0) {
                    ...
                    totalAmountSpendOn.setText("Total week's spending: $ "+ totalAmount);
                    monthSpendAmount.setText("Total spent: $ "+totalAmount);
                }
                else {
                    totalAmountSpendOn.setText("You've not spent week");
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(WeeklyAnalyticsActivity.this, "Child dose not exist", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    float appTotal;
                    if (snapshot.hasChild("weekCha")){
                        appTotal = Integer.parseInt(snapshot.child("weekCha").getValue().toString());
                    } else {
                        appTotal = 0;
                    }
